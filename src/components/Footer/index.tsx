import { Box, Col, Flag, Row } from '../Ui';
...
const LinksGroupTitle = styled('li', {
    fontSize: '1rem',
    fontWeight: '$bold',
    marginBottom: '$s1',
    color: '$white'
...
export default function Footer({ lang }: FooterProps) {
    return (
        <FooterStyle>
            <Row className="align-itens-center info-content">
                <Col col={{ '@lg': 3 }}>
                    <a
                        href={`/${lang}/`}
                        title="Azion Technologies"
                        className="azion-technologies"
                    >
                        <svg
                            width="200"
                            height="26"
                        ...
                        >
                            ...
                            />
                            <path
                                d="M158.674 21.8214L161.198 10.8137H162.093L159.569 21.8214H158.674Z"
                                fill="white"
                            />
                            <path
                    ...
                    <Box
                        ...
                        dangerouslySetInnerHTML={{
                            __html: footerContent.sales_and_support
                        }}
                        css={{
                            color: '$white',
                            fontSize: '$s1',
                ...
                <Col col={{ '@lg': 14 }} offset={{ '@lg': 3 }}>
                    <LinksGroup>
                        {footerContent.links.map(({ title, items }, index) => (
                            <LinksGroupUl key={index}>
                                <LinksGroupTitle>{title}</LinksGroupTitle>
                                {items.map(({ title, slug, flag }) => (
                                    <LinksGroupLi key={title}>
                                        <a href={slug}>{title}</a>
                                        {flag ? (
                                            <Flag small>{flag}</Flag>
                                        ) : null}
                                    </LinksGroupLi>
                                ))}
                            </LinksGroupUl>
            ...
            <Row css={{ alignItems: 'center' }}>
                ...
                <Col
                    col={{ '@sm': 4, '@md': 5, '@sd': 7, '@lg': 10 }}
                    offset={{ '@lg': 5, '@slg': 8 }}
                >
                    <Copyright
                        dangerouslySetInnerHTML={{
                            __html: footerContent.copyright
                        }}
                    />
                </Col>
            </Row>
