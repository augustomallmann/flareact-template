import { BuildTagsParams, OpenGraphMedia } from '../../types/seo';
...
export const handleGenerateTags = (config: BuildTagsParams) => {
    ...
    if (config.openGraph) {
        ...
        if (config.defaultOpenGraphImageWidth) {
            defaults.defaultOpenGraphImageWidth =
                config.defaultOpenGraphImageWidth;
        }
        ...
        if (config.defaultOpenGraphVideoWidth) {
            defaults.defaultOpenGraphVideoWidth =
                config.defaultOpenGraphVideoWidth;
        }
